...
<body>
	...
	<div class="text-center">
		<h1>Let's edit Fast Air airport!</h1> </div>
	<hr>
	<div class="mb-3">
	...
	<div class="mb-3">
		...
		<input type="email" class="form-control" id="exampleFormControlInput1" placeholder="38.406942, 16.249758"> </div> <a class="btn btn-success" href="#" role="button">Edit</a> </body>
