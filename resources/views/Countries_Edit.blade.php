...
<body>
	...
	<div class="text-center">
		<h1>Let's edit Italy country!</h1> </div>
	<hr>
	<div class="mb-3">
		<label for="exampleFormControlInput1" class="form-label">Name</label>
		<input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Italy"> </div>
	<div class="mb-3">
		<label for="exampleFormControlInput1" class="form-label">ISO Code</label>
		<input type="email" class="form-control" id="exampleFormControlInput1" placeholder="4321"> </div> <a class="btn btn-success" href="#" role="button">Edit</a> </body>
