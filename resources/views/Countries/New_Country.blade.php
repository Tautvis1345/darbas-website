...
<body>
	...
	<div class="text-center">
		<h1>Let's create a new country!</h1> </div>
	<hr>
	<div class="mb-3">
	...
	<div class="mb-3">
		...
		<input type="email" class="form-control" id="exampleFormControlInput1" placeholder=""> </div> <a class="btn btn-success" href="#" role="button">Create</a> </body>
